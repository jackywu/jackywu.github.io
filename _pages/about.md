...
从最初的`IDC工程师`到`高级开发工程师`，到后来作为`技术主管`带团队做项目，以及目前作为`架构师`带领团队做基础平台型项目的研发，历时约8年时间的技术积累和管理经验积累，我的视野跟格局得到了很大的提升，并且注意力发生了转移，不再仅仅关注技术本身，更多关注技术带来的具体价值。希望在能够实现社会价值和自我价值的地方，修炼我下一个10年的职业生涯。
